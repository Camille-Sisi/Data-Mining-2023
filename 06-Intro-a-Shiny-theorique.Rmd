...
# Les applications interactives avec Shiny App  {#c06-Intro-a-Shiny-theorique}
<div align="justify">
...
Des exemples d'application Shiny sont données sur la page officielle dans la <a href="https://shiny.rstudio.com/gallery/" target="_blank">galerie</a> ; ou on peut aussi en lancer une directement dans R, avec par exemple le code suivant :
```{r eval=FALSE}
